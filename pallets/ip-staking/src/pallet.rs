...
pub mod pallet {
    ...
    /// Registered IP to the developer who registered it
    #[pallet::storage]
    ...
    pub enum Event<T: Config> {
        ...
        /// Contract removed from IP staking.
        ContractRemoved(T::AccountId, T::SmartContract),
        /// New IP staking era. Distribute era rewards to contracts.
    ...
    impl<T: Config> Hooks<BlockNumberFor<T>> for Pallet<T> {
        fn on_initialize(now: BlockNumberFor<T>) -> Weight {
                ...
                || previous_era.is_zero()
            {
                ...
                Self::deposit_event(Event::<T>::NewIpStakingEra(next_era));
            }
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn register(
            ...
            let developer = ensure_signed(origin)?;
                ...
                !RegisteredIp::<T>::contains_key(&contract_id),
            ...
            RegisteredIp::<T>::insert(contract_id.clone(), developer.clone());
        ...
        /// Unregister existing contract from IP staking
        ///
        ...
        pub fn claim(
            ...
            let developer =
                RegisteredIp::<T>::get(&contract_id).ok_or(Error::<T>::NotOperatedContract)?;
    ...
    impl<T: Config> Pallet<T> {
        ...
        fn is_active(contract_id: &T::SmartContract) -> bool {
            if let Some(developer) = RegisteredIp::<T>::get(contract_id) {
