...
construct_runtime_modified!(
    pub enum Runtime
    {
        ...
        MaintenanceMode: pallet_maintenance_mode = 7,
        ...
        Uniques: pallet_uniques = 80,

        OrmlXcm: orml_xcm = 90,
        Vesting: orml_vesting = 91,
        XTokens: orml_xtokens = 92,
        UnknownTokens: orml_unknown_tokens = 93,
